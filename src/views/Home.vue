    ...
    async info(){
        const alert = await alertController
            .create({
              ...
              subHeader: 'Creat per Jhon Moreno',
              message: 'Podeu trobar el codi font a: <a href="https://github.com/Jhon1348/ComptadorIonic">https://github.com/Jhon1348/ComptadorIonic</a>',
              buttons: ['OK'],
            });
        await alert.present();
    },
